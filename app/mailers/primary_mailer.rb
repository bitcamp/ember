class PrimaryMailer < ActionMailer::Base
    ...
    def registration(email, token)
        content = '<h1>Hey!</h1><p>Bitcamp Waiver</p><p><a href="https://bitca.mp/api/viewform?token=' + token + '&redirect=register.two">Click here</a> to confirm your email and continue the registration process.</p> Please email hello@bitca.mp if you have any questions. </p><hr><p> Hack on, <br>Bitcamp Team </p>' 
        mail(to: email, body: content, 
